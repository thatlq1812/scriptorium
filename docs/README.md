...
| `../outside_research/` (repo root) | Living input — thatlq1812-authored surveys and external AI-assisted analysis on candidate audiences/verticals, gathered before a tier is built. Distilled into `ROADMAP.md`/`specs/STRATEGY_SPEC.md`; its brainstormed skill lists are ideation only, not elicited input. |
