...
| --- | --- | --- | --- | --- | --- |
| `skill-creator` | 0.2.0 | N2 | `null` | `passed` | **Not yet official** — security-audit clean, but hasn't passed stage 4 (quality eval, ≥2 harnesses). |
...
| `scout-harvester` | 0.1.0 | N1 | `null` | `passed` | **Not yet official** — distilled from 3 real runs this session (Docling, uv, anthropics/skills), hasn't passed stage 4. |
