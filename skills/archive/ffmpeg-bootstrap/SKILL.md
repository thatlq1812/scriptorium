...
```bash
uv pip install --python .venv -r skills/media/ffmpeg-bootstrap/requirements.txt
```
...
```bash
.venv\Scripts\python.exe skills\media\ffmpeg-bootstrap\scripts\check_ffmpeg.py
```
...
.\skills\media\ffmpeg-bootstrap\scripts\install_ffmpeg_system.ps1
# macOS/Linux:
bash skills/media/ffmpeg-bootstrap/scripts/install_ffmpeg_system.sh
```
