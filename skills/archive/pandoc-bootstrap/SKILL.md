...
```bash
python skills/general/pandoc-bootstrap/scripts/check_pandoc.py
```
...
.\skills\general\pandoc-bootstrap\scripts\install_pandoc.ps1
# macOS/Linux:
bash skills/general/pandoc-bootstrap/scripts/install_pandoc.sh
```
