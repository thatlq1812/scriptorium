...
additionally needs a working LaTeX engine (see xelatex-bootstrap) -- this
...
def main() -> int:
    ...
    print("Note: converting TO .pdf additionally needs a working LaTeX engine -- see xelatex-bootstrap if that's needed.")
    return 0
