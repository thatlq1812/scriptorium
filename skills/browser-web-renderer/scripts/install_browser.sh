...
bash "$repo_root/skills/python-env-bootstrap/scripts/bootstrap.sh" "$repo_root/skills/browser-web-renderer/requirements.txt"
...
echo ""
echo "Done. Run:"
echo "  .venv/bin/python skills/browser-web-renderer/scripts/check_browser.py"
echo "to confirm."
