...
- Doesn't cover prior system's administrative-paperwork skill types — deliberately out of scope for this tier, per owner direction (see `lesson-plan-builder/SKILL.md`).
