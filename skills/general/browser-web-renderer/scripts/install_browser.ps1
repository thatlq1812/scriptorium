...
& "$RepoRoot\skills\general\toolchain-bootstrap\scripts\bootstrap.ps1" -Requirements "$RepoRoot\skills\general\browser-web-renderer\requirements.txt"
...
Write-Host ""
Write-Host "Done. Run:"
Write-Host "  .venv\Scripts\python.exe skills\general\browser-web-renderer\scripts\check_browser.py"
