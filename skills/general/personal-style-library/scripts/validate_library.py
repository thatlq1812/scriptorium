...
_SKILLS_ROOT = _SCRIPTS_DIR.parents[2]

_brand_identity_linter = next(_SKILLS_ROOT.glob("*/brand-identity-linter"), None)
if _brand_identity_linter is None:
    sys.exit(
...
sys.path.insert(0, str(_brand_identity_linter / "scripts"))
