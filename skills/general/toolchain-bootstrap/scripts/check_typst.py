...
(mirrors this same skill's shared `.venv/` pattern (see bootstrap.ps1/.sh) -- a single portable
...
def main() -> int:
    ...
    if path is None:
        ...
        print(
            "Suggested: python skills/general/toolchain-bootstrap/scripts/install_typst.py "
