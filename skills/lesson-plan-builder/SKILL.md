...
- No support yet for `theme_lesson_plan`-style multi-lesson themed units or `cross_subject_plan`-style interdisciplinary/STEM lesson plans (both real EduStation variants) — v0.1.0 covers the single-lesson case only; a future version could add these as additional structure profiles if real use shows the need.
