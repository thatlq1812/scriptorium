...
```bash
.venv\Scripts\python.exe skills\media\poster-generator\scripts\render_poster.py layout.json content.json poster.png --dpi 150
```
...
```bash
.venv\Scripts\python.exe skills\media\poster-generator\scripts\suggest_layout.py elements.json suggested_layout.json
```
