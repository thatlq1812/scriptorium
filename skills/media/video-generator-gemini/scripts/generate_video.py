...
Motion intensity (phrasing-based, like image-generator-gemini's strength
...
# same situation as image-generator-gemini's identity/style strength, so the
# same phrasing-based-level pattern is reused here for consistency across
# this project's Gemini skills, not because it's the only conceivable design.
_MOTION_PHRASE = {
