...
bash skills/meta/python-env-bootstrap/scripts/bootstrap.sh skills/<target_skill>/requirements.txt [python_version]

# Windows: ALWAYS run via real PowerShell, not Git Bash:
.\skills\meta\python-env-bootstrap\scripts\bootstrap.ps1 -Requirements skills\<target_skill>\requirements.txt [-PyVersion 3.12]
```
