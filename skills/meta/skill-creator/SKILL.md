...
metadata:
  ...
  elicited_from: "Owner tacit knowledge from the early system postmortem (docs/archive/pre-spec-2026-07-26/handoff.md) + deep research session 2026-07-26, distilled into docs/specs/STRATEGY_SPEC.md"
  version: 0.4.0
...
See `templates/README.md` for the full rationale (adapted from `prior project templates` — the owner's prior project — keeping the copy-a-skeleton principle, dropping the harness-specific machinery).
