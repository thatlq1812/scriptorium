...
Typst is a single ~50MB static binary (see skills/general/toolchain-bootstrap). The
...
def main() -> int:
    ...
    if args.compile:
        ...
        if typst_bin is None:
            print("COMPILE SKIPPED: typst not found (see toolchain-bootstrap).", file=sys.stderr)
            return 0
