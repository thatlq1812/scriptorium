...
================================================================================
  ...
  exist. If not, stop — see skills/skill-creator/SKILL.md.
================================================================================
-->
---
...
<!-- ◆ If Python is needed: use the SHARED venv via python-env-bootstrap, never
     a per-skill venv. See skills/python-env-bootstrap/SKILL.md for the exact
