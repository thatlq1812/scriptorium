...
```bash
python skills/xelatex-bootstrap/scripts/check_toolchain.py
```
...
.\skills\xelatex-bootstrap\scripts\install_toolchain.ps1
# macOS/Linux:
bash skills/xelatex-bootstrap/scripts/install_toolchain.sh
```
